...
test('company uses custom fields', function () {
    ...
    expect(class_implements($company))->toContain(\Telis\CustomFields\Models\Contracts\HasCustomFields::class)
        ->and(class_uses_recursive($company))->toContain(\Telis\CustomFields\Models\Concerns\UsesCustomFields::class);
})->todo();
