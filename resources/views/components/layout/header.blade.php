    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex-shrink-0 transition-transform duration-300 hover:scale-105 w-auto flex items-center">
                <a href="{{ url('/') }}" class="flex items-center space-x-2 group" aria-label="Telis Home">
                    <img class="h-10 w-auto sm:h-12 transform group-hover:rotate-3 transition-transform" src="{{ asset('telis-logo.svg') }}" alt="Telis Logo">
                    <span class="font-bold text-lg text-primary dark:text-white hidden sm:block">Telis</span>
                </a>
            </div>
