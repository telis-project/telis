...
<footer class="py-12 md:py-16 border-t border-gray-100 dark:border-gray-900 bg-white dark:bg-black">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div
            ...
            <div class="md:col-span-5 space-y-5">
                <div class="flex items-center space-x-3">
                    ...
                    <span class="font-semibold text-lg text-black dark:text-white">Telis</span>
                </div>
                ...
                <div class="flex space-x-4">
                    <a href="https://github.com/Telis/telis" target="_blank" rel="noopener"
                       class="text-gray-400 hover:text-primary dark:hover:text-primary-400 transition-colors"
                       aria-label="GitHub">
                        <span class="sr-only">GitHub</span>
                        <x-icon-github class="h-5 w-5" />
                    </a>
                    <a href="https://x.com/telis" target="_blank" class="text-gray-400 hover:text-primary dark:hover:text-primary-400 transition-colors"
                       aria-label="X">
                        <span class="sr-only">X</span>
                        <x-heroicon-o-chat-bubble-left-right class="h-5 w-5" />
                    </a>
                    <a href="https://www.linkedin.com/company/telis"  target="_blank" class="text-gray-400 hover:text-primary dark:hover:text-primary-400 transition-colors"
                       aria-label="LinkedIn">
        ...
        <div class="mt-8 flex flex-col md:flex-row md:justify-between items-center">
            <p class="text-gray-500 dark:text-gray-400 text-xs">&copy; {{ date('Y') }} Telis. All rights
                reserved.</p>
