        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-8 pb-10 border-b border-gray-200 dark:border-gray-800">
            ...
            <div class="md:col-span-3">
                ...
                <ul class="space-y-3">
                    ...
                    <li>
                        <a href="https://github.com/Telis" target="_blank" rel="noopener" class="text-gray-500 dark:text-gray-400 hover:text-black dark:hover:text-white text-sm transition-colors">
                            GitHub
                        </a>
                    </li>
                    <li>
