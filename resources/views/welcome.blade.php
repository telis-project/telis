            ...
            <div class="space-y-8">
                ...
                <div class="mt-10 flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6">
                    <a href="{{ route('register') }}"
                       class="group relative inline-flex items-center gap-1.5 bg-gradient-to-r from-primary to-primary/90 text-white px-8 py-4 rounded-xl text-lg font-medium shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/40 hover:-translate-y-0.5 transition-all duration-300">
                        Get Started
                    ...
                    <a href="https://github.com/telis/telis" target="_blank"
                       class="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl bg-white/80 backdrop-blur-sm text-slate-800 border border-slate-200 shadow hover:shadow-md hover:bg-white transition-all duration-300">
                ...
                <div
                    class="mt-16 relative max-w-5xl mx-auto transform perspective-1000 hover:scale-[1.01] transition-all duration-700">
                    <!-- Decorative elements -->
                    ...
                    <div class="relative bg-white rounded-xl shadow-2xl overflow-hidden border border-gray-200/80">
                        ...
                        <div class="bg-gray-100 border-b border-gray-200 px-4 py-2 flex items-center">
                            ...
                            <div class="ml-4 flex space-x-1">
                                <div
                                    class="px-4 py-1.5 rounded-t-lg bg-white text-sm font-medium text-gray-700 border-b-2 border-primary">
                                    Telis
                                </div>
                            </div>
                        ...
                        <div class="bg-white border-b border-gray-200 px-4 py-2 flex items-center">
                            ...
                            <!-- URL Bar -->
                            <div
                                class="ml-4 flex-1 bg-gray-100 rounded-md px-3 py-1 text-sm text-gray-600 flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 text-green-500" fill="none"
                                     viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                          d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>
                                </svg>
                                <span>app.telis.dev/dashboard</span>
                            </div>
                        ...
                        <div class="relative bg-gray-50">
                            <img src="{{ asset('images/app-preview.png') }}" alt="Telis CRM Dashboard"
                                 class="w-full h-auto" loading="lazy">
                            <!-- Subtle overlay to integrate with browser frame -->
                            <div
                                class="absolute inset-0 bg-gradient-to-t from-transparent via-transparent to-white/5 pointer-events-none"></div>
                            <!-- Mouse cursor for added realism -->
                            <div class="absolute hidden md:block" style="top: 30%; left: 45%;">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                     fill="none" stroke="currentColor" stroke-width="2"
                                     class="text-gray-800 opacity-70">
                    ...
                    <div class="p-8 md:p-10 md:col-span-3">
                        <div class="text-center md:text-left">
                            ...
                            <p class="text-gray-600 mb-8">
                                As an open-source platform written with Laravel and Filament, Telis thrives on
