    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div class="space-y-10 md:space-y-12">
            ...
            <div class="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-5">
                ...
                <a href="https://github.com/telis/telis" target="_blank" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 rounded-md text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white border border-gray-200 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-700 transition-colors duration-200">
