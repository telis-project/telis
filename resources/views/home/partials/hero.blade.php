    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div class="space-y-14 md:space-y-16">
            ...
            <div class="flex flex-col sm:flex-row justify-center items-center gap-4">
                ...
                <a href="https://github.com/telis/telis" target="_blank" class="group w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-md text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white border border-gray-200 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-700 transition-all duration-200 bg-white/50 dark:bg-black/50">
                ...
                <div class="bg-white dark:bg-gray-900 rounded-lg overflow-hidden border border-gray-100 dark:border-gray-800 shadow-lg dark:shadow-gray-950/20 hover:shadow-xl transition-shadow duration-300">
                    ...
                    <div class="relative">
                        <picture>
                            ...
                            <img src="{{ asset('images/app-preview.png') }}" alt="Telis CRM Dashboard" class="w-full h-auto" width="1200" height="675" loading="lazy">
                        </picture>
