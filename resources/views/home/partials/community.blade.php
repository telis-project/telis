    ...
    <div class="container max-w-6xl mx-auto px-6 lg:px-8 relative">
        ...
        <div class="max-w-3xl mx-auto text-center mb-16 md:mb-20">
            ...
            <p class="mt-5 text-base md:text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
                As an open-source platform, Telis thrives on community collaboration. Join our growing community to get help, share ideas, and contribute.
            </p>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                ...
                <div class="bg-gray-50 dark:bg-gray-900 p-8 rounded-xl">
                    <div class="flex flex-col h-full">
                        ...
                        <p class="text-gray-600 dark:text-gray-300 mb-6 text-sm">Star our repo, report issues, and contribute code. Telis is completely open source and free to use, modify and distribute.</p>
                        <div class="mt-auto">
                            <a href="https://github.com/telis/telis" target="_blank" class="inline-flex items-center text-primary dark:text-primary-400 hover:text-primary-600 dark:hover:text-primary-300 font-medium text-sm transition-colors">
                                View Repository
                ...
                <div class="bg-gray-50 dark:bg-gray-900 p-8 rounded-xl">
                    <div class="flex flex-col h-full">
                        ...
                        <p class="text-gray-600 dark:text-gray-300 mb-6 text-sm">Chat with developers, get help, and share ideas. Join our growing community and connect with other Telis users.</p>
                        <div class="mt-auto">
                ...
                <div class="bg-gray-50 dark:bg-gray-900 p-8 rounded-xl">
                    <div class="flex flex-col h-full">
                        ...
                        <p class="text-gray-600 dark:text-gray-300 mb-6 text-sm">Learn how to use Telis and help improve our docs. Comprehensive guides for users and developers alike.</p>
                        <div class="mt-auto">
