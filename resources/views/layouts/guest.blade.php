...
<head>
    ...
    <title>{{ config('app.name', 'Telis') }}</title>
    {{--<title>Telis - The Next-Generation Open-Source CRM Platform</title>--}}
    <!-- Fonts -->
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center py-4">
            ...
            <div class="flex-shrink-0 transition-transform duration-300 hover:scale-105">
                <a href="{{ url('/') }}" class="flex items-center space-x-1" aria-label="Telis Home">
                    <img class="h-12 w-auto" src="{{ asset('telis-logo.svg') }}" alt="Telis Logo">
                    <span class="font-semibold text-lg text-[#4841D5] hidden sm:block">Telis</span>
                </a>
            </div>

            <!-- Desktop Navigation Links -->
            <nav class="hidden md:flex space-x-6 items-center">
                <a href="https://github.com/Telis" target="_blank" rel="noopener"
...
<footer class="bg-gradient-to-b from-gray-900 to-gray-900 text-white py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="space-y-4">
                <div class="flex items-center space-x-2">
                    <img class="h-10 w-auto" src="{{ asset('telis-logo.svg') }}" alt="Telis Logo">
                    <span class="font-bold text-xl">Telis</span>
                </div>
                ...
                <div class="flex space-x-4 pt-2">
                    <a href="https://github.com/Telis" target="_blank" rel="noopener" class="text-gray-300 hover:text-white transition-colors duration-200" aria-label="GitHub">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="https://github.com/Telis" target="_blank" rel="noopener" class="text-gray-300 hover:text-white transition-colors duration-200 flex items-center gap-2">
        ...
        <div class="mt-8 pt-4 border-t border-gray-700 flex flex-col md:flex-row md:justify-between items-center text-sm">
            <p>&copy; 2025 Telis. All rights reserved.</p>
