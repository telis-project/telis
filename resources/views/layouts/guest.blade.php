    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center py-4">
            ...
            <div class="flex-shrink-0 transition-transform duration-300 hover:scale-105">
                <a href="{{ url('/') }}" class="flex items-center space-x-2" aria-label="Telis Home">
                    <img class="h-10 w-auto" src="{{ asset('telis-logo.svg') }}" alt="Telis Logo">
                    <span class="font-semibold text-lg text-primary hidden sm:block">Telis</span>
                </a>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="space-y-4">
                <div class="flex items-center space-x-2">
                    <img class="h-8 w-auto" src="{{ asset('telis-logo.svg') }}" alt="Telis Logo">
