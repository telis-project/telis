...
**Data Model (Custom Fields)** - A powerful Filament plugin **developed by Telis** that serves as the backbone for
...
- **Marketplace
  **: [filamentphp.com/plugins/telis-custom-fields](https://filamentphp.com/plugins/telis-custom-fields)
...
This is the **only** paid component in the Telis ecosystem. While we're committed to open source, this particular
module represents a significant intellectual property investment that enables Telis to deliver unparalleled
