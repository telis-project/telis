...
<x-guest-layout 
    ...
    :description="!empty($documentTitle) ? $documentTitle . ' - Telis Documentation' : 'Comprehensive documentation for Telis - The Next-Generation Open-Source CRM Platform. Learn how to install, configure, and use Telis effectively.'"
    :ogTitle="!empty($documentTitle) ? $documentTitle . ' - ' . config('app.name') . ' ' . __('Documentation') : config('app.name') . ' - Documentation'"
    :ogDescription="!empty($documentTitle) ? 'Learn about ' . $documentTitle . ' in the Telis documentation.' : 'Explore the Telis documentation. Learn how to get started, configuration options, and advanced features of our open-source CRM platform.'">
    @pushonce('header')
