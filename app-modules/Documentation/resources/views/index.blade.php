    ...
    <div class="container px-4 py-12 mx-auto">
        <header class="mb-12 text-center">
            ...
            <p class="text-xl text-gray-600 max-w-2xl mx-auto">
                Welcome to the Telis documentation hub. Here you'll find guides and resources to help you get the
                most out of Telis CRM.
            </p>
        </header>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                >
                    <p class="text-gray-600">
                        The Business Guide provides an overview of Telis from a business perspective. It explains
                        how Telis can benefit your organization and how to leverage its features effectively.
                    </p>
                </x-documentation::card>
                ...
                >
                    <p class="text-gray-600">
                        ...
                        Telis API. It includes authentication methods, endpoint details, and best practices for API
                        usage.
                    </p>
                </x-documentation::card>
            </div>
