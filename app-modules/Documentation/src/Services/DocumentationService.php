...
namespace Telis\Documentation\Services;

use Illuminate\Support\Collection;
use Illuminate\Support\Facades\Cache;
use Illuminate\Support\Str;
use Telis\Documentation\Data\DocumentData;
use Telis\Documentation\Data\DocumentSearchRequest;
use Telis\Documentation\Data\DocumentSearchResultData;
...
final class DocumentationService
{
    ...
    public function getDocument(string $type): DocumentData
    {
        ...
        return Cache::remember(
            ...
            fn (): \Telis\Documentation\Data\DocumentData => DocumentData::fromType($type)
        );
    }
