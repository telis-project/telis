...
final class GitHubService
{
     ...
     */
    public function getStarsCount(string $owner = 'Telis', string $repo = 'telis', int $cacheMinutes = 60): ?int
    {
     ...
     * @param  int  $cacheMinutes  Minutes to cache the result (default: 60)
     */
    public function getFormattedStarsCount(string $owner = 'Telis', string $repo = 'telis', int $cacheMinutes = 60): string
    {
